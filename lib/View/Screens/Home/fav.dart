...
Widget _cart({required Cartcontroller controller, required int carindex}) {
  var prod =
      controller.getProductById(id: controller.favList[carindex].productId);
  if (prod != null) {
    return Container(
            ...
            children: [
              Row(
                children: [
                  InkWell(
                    onTap: () {
                      controller.removeFromfav(controller.favList[carindex].id);
                    },
                    child: Container(
              ...
              Container(
                ...
                child: Text(
                    ((prod.price)! * (controller.favList[carindex].quntity!))
                            .toString() +
                        'le'.tr),
              )
            ],
