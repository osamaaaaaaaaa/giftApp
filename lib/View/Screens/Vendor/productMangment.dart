...
class Productmangment extends StatelessWidget {
  ...
  Productmangment({this.proudactsModel}) {
                              ...
                              if (proudactsModel != null) {
                                controller.editProudct(
                                    model: ProudactsModel(
                                        ...
                                        vendorId: controller.user,
                                        status: false));
                                return;
                              }
                              controller.addnewProudact(
                                  model: ProudactsModel(
                                      name: prodname.text,
                                      description: proddesc.text,
                                      quantity: int.parse(prodquntity.text),
                                      price: double.parse(prodprice.text),
                                      thumb: controller.imagesUrl[0],
                                      additional_images:
                                          List.from(controller.imagesUrl),
...
Widget _categories({required Vendorcontroller controller}) => Container(
